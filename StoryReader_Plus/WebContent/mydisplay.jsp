...
<head>
	<link rel="stylesheet" href="CSS/mydisplay.css">
</head>
<body>
	...
	<div class="main">
		...
		<div class = "story-modify">
			<form id="modifyFrm">
				<a href="javascript:void(0);" onclick="modifyStory('/StoryReader_Plus/EditStory')">수정하기</a> 
				<a href="javascript:void(0);" onclick="modifyStory('/StoryReader_Plus/DeleteStory')">삭제하기</a>
			</form>
		</div>
		<div class = "script">
	...
	function next(){
	 ...
	 function modifyStory(url) { // get, post type 따른 doGet, doPost method 로그용 parameter 
		
		var frm = document.getElementById("modifyFrm"); 
		if(url == '/StoryReader_Plus/DeleteStory'){//삭제
		...
		}else if(url=='/StoryReader_Plus/EditStory'){//수정
			frm.method = "post"; 
			frm.action = url; 
		 	frm.submit(); 	
		}
